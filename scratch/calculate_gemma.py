...
def main():
    json_path = Path("C:/Users/MOHAMMED ZAID/.gemini/antigravity-ide/brain/13934fab-22fd-42d4-a54a-f1dd37a8467f/evaluation_gemma_raw_results.json")
    ...
    out_file = Path("scratch/formatted_results_gemma.txt")
